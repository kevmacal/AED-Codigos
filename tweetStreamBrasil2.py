...
file_raw = open('./data/dataStreamBrasil2_' + time.strftime('%Y%m%d') + '.json', 'a')
...
class StdOutListener(StreamListener):
    ...
    def on_data(self, data):
        ...
        if tweet['coordinates']:
            ...
            print (("Tweet Brasil2 Coordinates:" + str(tweet['coordinates']) + "Numero: " + str(self.contTweets)))
        return True
...
#    stream.filter(locations=[-124.482009887695, 32.5295219421387, -114.13077545166, 42.0095024108887,]) California
    stream.filter(locations=[-49.235594, -5.172552, -32.511852, -31.800720])  # Brasil2
